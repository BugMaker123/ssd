package cn.com.ice.ordercenter.utils;
...
public class RedisUtil {
	 ...
	 * @return
	 */
	public static Set<String> keys(String pat) {
		try {
			return redisTemplate.keys(pat);
		} catch (Exception e) {
			log.error(pat, e);
			return null;
		}
	...
	public static void convertAndSend(String channel, Object message) {
		try {
			...
			log.error("发送消息异常channel："+channel+"，message："+message,e);
		}
	}
	// ============================String=============================
	/**
	 ...
	 * @return
	 */
	public static Boolean setNx(String key, Object value, @NotNull Long time) {
		try {
	...
	public static Object zSRange(String key,int start, int end){
		try {
