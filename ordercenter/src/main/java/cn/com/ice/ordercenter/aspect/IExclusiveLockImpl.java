...
@Slf4j
@Component
public class IExclusiveLockImpl implements IExclusiveLock{
     ...
     * 默认锁过期时间
     */
    public static final int DEFAULT_LEASE_TIME=8;
    ...
    public boolean tryLock(String lockKey) {
        return  tryLock(lockKey,DEFAULT_TIME_UNIT,DEFAULT_TIMEOUT,DEFAULT_LEASE_TIME);
    }
